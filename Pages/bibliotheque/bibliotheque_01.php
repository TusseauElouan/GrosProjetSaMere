    ...
    <table>
        ...
        <tbody>
            ...
            while ($resultats = $temp -> fetch()){
                ?>
                    <tr>
                        <th scope='row'><?php echo $resultats['ville']?></th>
                        <td><?php echo $resultats3['commentaire']?></td>

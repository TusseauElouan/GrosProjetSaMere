    ...
    <table>
        ...
        <tbody>
            ...
            while ($resultats = $temp->fetch()) {
                ...
                <tr>
                    <th scope='row'>
                        <?php echo $resultats['ville_bibliotheque'] ?>
                    </th>
                    <td>
                        <?php echo $resultats['commentaire'] ?>
                    </td>
                    <td><a href='bibliotheque_03.php?id_bibliotheque=<?php echo $resultats['numero_bibliotheque'] ?>'><svg
                    ...
                    <td><a
                            href='bibliotheque_01.php?type=supp&numero_bibliotheque=<?= $resultats['numero_bibliotheque'] ?>'><svg
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
